      ...
      {OPTIONS.map((o) => {
        ...
        return (
          <button
            ...
            className={`flex items-center gap-1 rounded-md px-2 py-1 text-2xs font-semibold transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring ${
              active
