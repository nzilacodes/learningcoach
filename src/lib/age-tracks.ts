...
export interface AgeTrack {
  ...
  games: Array<{
    ...
    emoji: string;
    xp: number;
    cat: "vocabulary" | "grammar" | "speaking" | "listening" | "writing" | "mixed";
    level: string;
    dur: string;
    rating: number;
    locked?: boolean;
...
export const AGE_TRACKS: Record<AgeGroup, AgeTrack> = {
  ...
  adults: {
    ...
    examples: [
      ...
      {
        en: "I’d like to walk you through the proposal.",
        pt: "Gostaria de guiá-lo pela proposta.",
      },
      {
        en: "We need alignment with all stakeholders.",
        pt: "Precisamos de alinhamento com todos os envolvidos.",
      },
