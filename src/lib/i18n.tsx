...
export const dict = {
  ...
  "hero.trust": { pt: "Já são mais de 12.400 alunos aprendendo", en: "12,400+ learners already onboard" },

  "modes.title": { pt: "Um curso para cada idade", en: "A course for every age" },
  "modes.sub": { pt: "O Coach adapta cor, ritmo e conteúdo automaticamente.", en: "The Coach adapts colors, pace and content automatically." },
  "modes.kids": { pt: "Crianças", en: "Kids" },
  "modes.kids.age": { pt: "5–11 anos", en: "5–11 years" },
  "modes.kids.desc": { pt: "Personagens animados, histórias, canções e jogos coloridos.", en: "Animated characters, stories, songs and colorful games." },
  "modes.teen": { pt: "Adolescentes", en: "Teens" },
  "modes.teen.age": { pt: "12–17 anos", en: "12–17 years" },
  "modes.teen.desc": { pt: "Temas de escola, música, tecnologia e redes sociais.", en: "School topics, music, tech and social media." },
  "modes.adult": { pt: "Adultos", en: "Adults" },
  "modes.adult.age": { pt: "18+ anos", en: "18+ years" },
  "modes.adult.desc": { pt: "Business English, IELTS, TOEFL e conversação profissional.", en: "Business English, IELTS, TOEFL and professional conversation." },

  "features.title": { pt: "Tudo que você precisa para dominar o inglês", en: "Everything you need to master English" },
  "features.ai": { pt: "AI Coach", en: "AI Coach" },
  "features.ai.desc": { pt: "Tutor 24/7 que corrige gramática, pronúncia e escrita.", en: "24/7 tutor that corrects grammar, pronunciation and writing." },
  "features.ipa": { pt: "Pronúncia com IPA", en: "IPA pronunciation" },
  "features.ipa.desc": { pt: "Compare sua voz com falantes nativos em tempo real.", en: "Compare your voice with native speakers in real time." },
  "features.placement": { pt: "Teste diagnóstico", en: "Placement test" },
  "features.placement.desc": { pt: "Descubra seu nível CEFR de A1 a C2 em minutos.", en: "Find your CEFR level from A1 to C2 in minutes." },
  "features.games": { pt: "Gamificação", en: "Gamification" },
  "features.games.desc": { pt: "XP, moedas, ligas e conquistas diárias.", en: "XP, coins, leagues and daily achievements." },
  "features.cert": { pt: "Certificados", en: "Certificates" },
  "features.cert.desc": { pt: "Certificado com QR de verificação a cada nível concluído.", en: "Certificate with QR verification per level completed." },
  "features.community": { pt: "Salas por idade", en: "Age-based rooms" },
  "features.community.desc": { pt: "Prática em comunidade com moderação por IA.", en: "Community practice with AI moderation." },

  "levels.title": { pt: "Da primeira palavra à fluência total", en: "From first word to full fluency" },
  "levels.sub": { pt: "Progrida por seis níveis CEFR. 80% para desbloquear o próximo.", en: "Progress through six CEFR levels. 80% unlocks the next." },

  "pricing.title": { pt: "Planos simples e diretos", en: "Simple, direct plans" },
  "pricing.sub": { pt: "Pagamento via Multicaixa Express. Cancele quando quiser.", en: "Pay via Multicaixa Express. Cancel anytime." },
  ...
  "cta.sub": { pt: "Faça o teste de nível gratuito e receba um plano personalizado em minutos.", en: "Take the free placement test and get a personalized plan in minutes." },
  "cta.button": { pt: "Fazer teste agora", en: "Start test now" },

  "footer.tag": { pt: "Aprenda inglês com um coach que entende você.", en: "Learn English with a coach who gets you." },
