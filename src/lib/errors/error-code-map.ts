...
export const ErrorCodeMap: Record<ErrorCode, CopyEntry> = {
  VALIDATION_ERROR: {
    ...
    description: { pt: "Corrija os campos indicados e tente novamente.", en: "Please fix the highlighted fields and try again." },
    retryable: false,
    action: "none",
    severity: "warning",
  },
  ...
  PERMISSION_DENIED: {
    ...
    description: { pt: "Não tem permissão para esta ação.", en: "You don't have permission for this action." },
    retryable: false,
    action: "none",
    severity: "warning",
  },
  NOT_FOUND: {
    ...
    description: { pt: "Este conteúdo já não está disponível.", en: "This content is no longer available." },
    retryable: false,
    action: "none",
    severity: "info",
  },
  CONFLICT: {
    ...
    description: { pt: "Esta ação já foi concluída anteriormente.", en: "This action was already completed." },
    retryable: false,
    action: "none",
    severity: "info",
  },
  RATE_LIMITED: {
    ...
    description: { pt: "Aguarde um instante e tente novamente.", en: "Please wait a moment and try again." },
    retryable: true,
    action: "retry",
    severity: "warning",
  },
  PAYMENT_REQUIRED: {
    ...
    description: { pt: "Esta funcionalidade requer um plano ativo.", en: "This feature requires an active plan." },
    retryable: false,
    action: "upgrade",
    severity: "info",
  },
  ...
  AI_SERVICE_TIMEOUT: {
    ...
    description: { pt: "Não conseguimos concluir a tempo. Tente novamente.", en: "We couldn't finish in time. Please try again." },
    retryable: true,
    action: "retry",
    severity: "warning",
  },
  AI_SERVICE_LIMIT_REACHED: {
    title: { pt: "Avaliação temporariamente indisponível", en: "Evaluation temporarily unavailable" },
    description: {
  ...
  NETWORK_ERROR: {
    ...
    description: { pt: "Verifique a sua conexão e tente novamente.", en: "Check your connection and try again." },
    retryable: true,
    action: "retry",
    severity: "error",
  },
  SERVER_ERROR: {
    ...
    description: { pt: "A equipa técnica foi informada.", en: "Our technical team has been notified." },
    retryable: true,
    action: "retry",
    severity: "error",
  },
  UNKNOWN_ERROR: {
    ...
    description: { pt: "Tente novamente. Se persistir, contacte o suporte.", en: "Please try again. Contact support if it persists." },
    retryable: true,
    action: "retry",
    severity: "error",
  },
